<template>
    <div class="center">
        <div class="main">
            <div class="results" id="results">{{msg}}</div>
            ...
            <div class="button square" id="square">X<sup>2</sup></div>
            <div class="button root" id="root"> √x</div>
            <div class="button divide" id="divide">/</div>
            <div class="button number" @click="numClicked(7)" id="seven">7</div>
            <div class="button number" @click="numClicked(8)" id="eight">8</div>
            <div class="button number" @click="numClicked(9)" id="nine">9</div>
            <div class="button times" id="times">*</div>
            ...
            <div class="button coma" id="coma">,</div>
            <div class="button equals" id="equals">=</div>
        </div>
    </div>
</template>
...
<script lang="ts">
    export default{
        setup(){
            let msg:string = "Let's do some math";
            let number1:number;
